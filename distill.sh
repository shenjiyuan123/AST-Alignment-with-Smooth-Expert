...
#SBATCH -w node03
#SBATCH --gres=gpu:4
#SBATCH --output /export/home2/jiyuan/mtt-distillation/outs/distill_flat.out
...
# distill 10 ipc
python distill.py --Iteration 5000 --epoch_eval_train 1000 --num_eval 1 --weight_perturb --balance_loss --agg_middle_loss --lr_img=10000 --lr_teacher 0.01 --lr_lr=1e-05 --dataset=CIFAR100 --ipc=10 --syn_steps=20 --expert_epochs=2 --max_start_epoch=30 --buffer_path='buffer_flat1' --data_path='data'
